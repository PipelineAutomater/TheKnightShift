...
export class StockfishService {
    ...
    private promotedPiece(piece: string|undefined): FENChar|null {
        ...
        return computerColor === Color.White ? FENChar.WhiteQueen : FENChar.BlackQueen; //Could switch statement be used here?
    }
    private moveFromStockfishString(move: string): ChessMove {
        ...
        const promotedPiece: FENChar|null = this.promotedPiece(move[4]);
